...
export const addFav = (character) => {
   ...
   const endpoint = "https://rick-and-morty-production-bd6a.up.railway.app/rickandmorty/fav"; //guarda la URL de nuestro servidor
...
export const removeFav = (id) => {
   ...
   const endpoint = `https://rick-and-morty-production-bd6a.up.railway.app/rickandmorty/fav/${id}`; //guarda la URL de nuestro servidor
